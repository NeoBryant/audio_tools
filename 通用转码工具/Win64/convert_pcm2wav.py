...
def process(input_dir, output_dir):
    ...
    for file in file_list:
        ...
        if os.path.isfile(file_path):
            ...
            param = exe_file + " --op=pcm2wav " + "--input_file=\"" + input_file + "\" --output_file=\"" + output_file + "\" --sample_freq=" + sample_rate
            os.system(param)
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 4:
        ...
        print ("Usage: python common_pcm2wav.py input_dir output_dir sample_rate")
        exit(-1)
