...
def process(input_dir, output_dir):
    ...
    for file in file_list:
        ...
        if os.path.isfile(file_path):
            ...
            param = exe_file + " --op=amr2wav " + "--input_file=\"" + input_file + "\" --output_file=\"" + output_file + "\" --sample_freq=" + sample_rate
            os.system(param)
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 4 and len(sys.argv) != 3:
        ...
        print ("Usage: python common_amr2wav.py input_dir output_dir")
        print ("or   : python common_amr2wav.py input_dir output_dir sample_rate")
        exit(-1)
    if len(sys.argv) == 4:
