...
def process(input_dir, output_dir):
    ...
    for file in file_list:
        ...
        if os.path.isfile(file_path):
            ...
            param = exe_file + " --op=trim " + "--input_file=\"" + input_file + "\" --output_file=\"" + output_file \
                    + "\" --start_time=\"" + start_time + "\" --duration_time=" + duration
            os.system(param)
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 5:
        ...
        print ("Usage: python common_resample.py input_dir output_dir start_time duration")
        exit(-1)
