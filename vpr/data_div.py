...
def parse_opt():
    ...
    parser.add_argument("--data_dir", type=str, default="/data6/zhengyu/data_1013/data_list")
    parser.add_argument("--save_list_dir", type=str, help="", default="/data6/zhengyu/data_1013/data_list/dataset")
    parser.add_argument("--valid_spks", type=int, default=2000)
